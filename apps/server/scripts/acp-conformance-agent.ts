...
const logPath = process.env.ZOG_ACP_CONFORMANCE_LOG_PATH;
const malformedPrefix = process.env.ZOG_ACP_CONFORMANCE_MALFORMED_PREFIX === "1";
...
const app = agent({ name: "zog-official-sdk-conformance-agent" })
