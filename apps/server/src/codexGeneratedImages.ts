...
import { isSupportedLocalImagePath as isSupportedLocalImagePathShared } from "@zog/shared/localPreviewFiles";
 ...
 * writes images under for the current process env. Zog uses its isolated
 ...
 * overlay `<ZOG_HOME>/codex-home-overlay/generated_images` so we serve
