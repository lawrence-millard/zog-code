...
import { resolveThreadWorkspaceCwd as resolveSharedThreadWorkspaceCwd } from "@zog/shared/threadEnvironment";

export const CHECKPOINT_REFS_PREFIX = "refs/zog/checkpoints";
