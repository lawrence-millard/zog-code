/**
 * AgentGateway - Zog app-control tool surface for provider agents.
 *
 * Serves the `zog_*` MCP tools that let any provider session (Codex,
 * Claude, Grok, ...) inspect and control Zog itself: list projects and
...
export class AgentGateway extends ServiceMap.Service<AgentGateway, AgentGatewayShape>()(
  "zog/agentGateway/Services/AgentGateway",
) {}
