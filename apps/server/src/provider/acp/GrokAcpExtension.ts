import type { ProviderUserInputAnswers, UserInputQuestion } from "@zog/contracts";
...
const ZOG_PLAN_REVIEW_FEEDBACK =
...
/**
 * Zog owns the approval step after the planning turn settles. Returning a
...
export function makeGrokExitPlanModeCapturedResponse(): {
  ...
  return {
    outcome: "cancelled",
    feedback: ZOG_PLAN_REVIEW_FEEDBACK,
  };
}

/** Zog has already received an implementation turn, so Grok may leave its native gate. */
