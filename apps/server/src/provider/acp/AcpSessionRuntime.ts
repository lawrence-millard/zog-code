...
export interface AcpSessionRuntimeOptions {
   ...
   * `mcpCapabilities` (e.g. HTTP vs stdio for the Zog agent gateway).
   */
...
/**
 * Bridges Effect's child-process exit signal into Zog's process-tree proof. This is deliberately
...
>()("zog/provider/acp/AcpSessionRuntime") {
  static layer(
