    ...
    return Effect.gen(function* () {
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          ...
          clientInfo: { name: "zog-test", version: "0.0.0" },
          authMethodId: "test",
          requestLogger: (event) =>
            Effect.sync(() => {
  ...
  it.effect("forwards provider session metadata when creating a session", () => {
    ...
    return Effect.gen(function* () {
      ...
      expect(sessionStarted?.payload).toMatchObject({
        _meta: {
          "x.ai/hooks": {
            PreToolUse: [{ matcher: "*", hookCallbackIds: ["zog-plan-guard"] }],
          },
        },
      });
    }).pipe(
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            env: {
              VITEST: "true",
              ZOG_ACP_FAIL_SESSION_NEW_ONCE: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "zog-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            command: bunExe,
            args: [mockAgentPath],
            env: { VITEST: "true", ZOG_ACP_SUPPORT_SESSION_RESUME: "1" },
          },
          cwd: process.cwd(),
          resumeSessionId: "mock-session-1",
          sessionMeta: { reconnectPolicy: "keep-hooks" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            command: bunExe,
            args: [mockAgentPath],
            env: { VITEST: "true", ZOG_ACP_SUPPORT_SESSION_LOAD: "0" },
          },
          cwd: process.cwd(),
          resumeSessionId: "mock-session-1",
          clientInfo: { name: "zog-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            env: {
              VITEST: "true",
              ZOG_ACP_SUPPORT_SESSION_FORK: "1",
              ZOG_ACP_EMIT_AVAILABLE_COMMANDS: "1",
              ZOG_ACP_MODE_CONFIG_ID: "autonomy_level",
            },
          },
          cwd: process.cwd(),
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            env: {
              VITEST: "true",
              ZOG_ACP_EMIT_INTERLEAVED_ASSISTANT_TOOL_CALLS: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "zog-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            env: {
              VITEST: "true",
              ZOG_ACP_EMIT_UPSTREAM_ASSISTANT_MESSAGE_IDS: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "zog-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            env: {
              VITEST: "true",
              ZOG_ACP_EMIT_GENERIC_TOOL_PLACEHOLDERS: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "zog-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            env: {
              VITEST: "true",
              ZOG_ACP_EMIT_REASONING_THEN_TOOL_CALL: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "zog-test", version: "0.0.0" },
