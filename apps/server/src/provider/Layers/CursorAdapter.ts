...
export const takeCursorZogHarnessPolicyTextPart = (
...
// forever. Generous by design; override with ZOG_CURSOR_TURN_IDLE_TIMEOUT_MS.
const CURSOR_TURN_IDLE_TIMEOUT_MS = resolveAcpTurnIdleTimeoutMs({
  envVar: "ZOG_CURSOR_TURN_IDLE_TIMEOUT_MS",
  defaultMs: 600_000,
});
...
const CURSOR_PLAN_MODE_PROMPT_PREFIX = [
  "Zog Cursor plan mode is active.",
  ...
  return Effect.gen(function* () {
    ...
    const sendTurn: CursorAdapterShape["sendTurn"] = (input) =>
      Effect.gen(function* () {
        ...
        const harnessPolicy = takeCursorZogHarnessPolicyTextPart(
          ctx,
