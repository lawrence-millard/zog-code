 ...
 * names. Because the migrator skips by ID, Zog migrations 17-31 never run
 ...
 * Zog migrations known at the time, but predecessor trackers eventually
 ...
 *
 * Idempotent and a no-op for fresh Zog installs (every column already
