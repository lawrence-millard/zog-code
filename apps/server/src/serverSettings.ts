...
import { deepMerge, type DeepPartial } from "@zog/shared/Struct";
import { applyServerSettingsPatch } from "@zog/shared/serverSettings";
import {
  Cause,
  Deferred,
  Effect,
...
export class ServerSettingsService extends ServiceMap.Service<
  ...
  ServerSettingsShape
>()("zog/serverSettings/ServerSettingsService") {
