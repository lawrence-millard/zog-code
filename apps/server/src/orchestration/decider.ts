...
import { doThreadMarkerRangesOverlap } from "@zog/shared/threadMarkers";
import { collectSubagentDescendants } from "@zog/shared/threadHierarchy";
...
> {
  switch (command.type) {
    ...
    case "thread.create": {
      ...
      // Zog never starts a session for them, so the Auto-mode capability
