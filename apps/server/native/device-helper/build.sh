#!/bin/bash
# Compiles zog-device-helper with the user's own Xcode toolchain.
#
...
#   ZOG_DEVICE_HELPER_OUT=/path build.sh
#
...
OUT_DIR="${1:-${ZOG_DEVICE_HELPER_OUT:-$SOURCE_DIR/build}}"
BINARY_NAME="zog-device-helper"
