// This file mostly exists because we want dev mode to say "Zog (Dev)" instead of "electron"
...
import { resolveZogDesktopFlavor, zogDesktopIdentity } from "@zog/shared/desktopIdentity";
...
const MICROPHONE_USAGE_DESCRIPTION =
  "Zog needs microphone access so you can record voice notes and transcribe them into the chat composer.";
