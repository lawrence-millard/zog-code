...
import { ProjectId, type OrchestrationShellSnapshot } from "@zog/contracts";
...
describe("isHomeChatContainerProject", () => {
  it("matches the managed Documents/Zog general-chat root used by older drafts", () => {
    expect(
      isHomeChatContainerProject(
        {
          cwd: "/Users/tester/Documents/Zog",
          kind: "chat",
          name: "Home",
          remoteName: "Home",
        },
  ...
  it("matches Codex-style date/slug chat workspaces under Documents/Zog", () => {
    expect(
      isHomeChatContainerProject(
        {
          cwd: "/Users/tester/Documents/Zog/2026-06-11/yes-it-takes-all-the-skills",
          kind: "chat",
          name: "Yes it takes",
  ...
  it("trusts the chat kind before any server workspace path resolves", () => {
    ...
    expect(
      isHomeChatContainerProject(
        {
          cwd: "/Users/tester/Documents/Zog/2026-06-11/some-chat",
          kind: "chat",
          name: "Some chat",
  ...
  it("does not classify ordinary projects under Documents/Zog as home chat containers", () => {
    expect(
      isHomeChatContainerProject(
        {
          cwd: "/Users/tester/Documents/Zog",
