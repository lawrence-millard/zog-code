...
import { isTemporaryWorktreeBranch, resolveUniqueZogBranchName } from "@zog/shared/git";
...
export function resolveDefaultCreateBranchName(
  ...
  return resolveUniqueZogBranchName(existingBranchNames, preferredBranch);
}
...
export { resolveAutoFeatureBranchName } from "@zog/shared/git";
