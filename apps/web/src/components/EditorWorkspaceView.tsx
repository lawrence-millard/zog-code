...
const EDITOR_CHAT_PANE_STORAGE_KEY = "zog.editor.chatPaneWidth";
const EDITOR_SIDEBAR_VISIBLE_STORAGE_KEY = "zog.editor.sidebarVisible";
const EDITOR_CHAT_PANE_VISIBLE_STORAGE_KEY = "zog.editor.chatPaneVisible";
