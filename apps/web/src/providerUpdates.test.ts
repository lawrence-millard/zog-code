...
import type { ProviderKind, ServerProviderStatus, ServerSettings } from "@zog/contracts";
...
describe("getVisibleProviderUpdateStatuses", () => {
  it("excludes providers hidden from Zog so unchecked providers do not nag", () => {
...
describe("shouldPromptProviderUpdate", () => {
  // Cursor and Antigravity self-update, so Zog has no registry to read a latest
  ...
  it("keeps prompting for providers Zog can prove are behind", () => {
