...
// Depends on: The public tryzog feedback endpoint.
...
export const FEEDBACK_CATEGORIES = [
  ...
  { value: "performance", label: "Performance", lead: "Zog felt slow" },
...
const DEFAULT_FEEDBACK_ENDPOINT = "https://code.zog.watch/api/feedback";
...
export function formatFeedbackSummary(input: {
  ...
  return [`${lead} in Zog ${diagnostics.appVersion}${usageContext}.`, "", ...detailLines].join(
    "\n",
  );
}
