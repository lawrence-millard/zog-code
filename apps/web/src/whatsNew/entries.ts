...
export const WHATS_NEW_ENTRIES: readonly WhatsNewEntry[] = [
    ...
    features: [
      {
        ...
        description:
          "Zog now keeps waiting for a healthy backend and recovers late connections instead of giving up while a large history is still loading.",
        details:
      ...
      },
      {
        ...
        description:
          "Workspace previews are now useful for small code and text edits without leaving Zog.",
        details:
    ...
    features: [
      {
        ...
        title:
          "A review of the Zog codebase found an analytics configuration that came from the original T3 Code codebase when Zog was created as a clone in March.",
        description:
          "We did not add it, and we have no access to the PostHog project receiving the events.",
        details:
          "The configuration has been removed. Zog no longer sends remote product analytics. The events did not include prompts, source code, filenames, or file contents. We're sorry this wasn't caught earlier",
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        description:
          "Create a project from a GitHub URL or repository name and let Zog prepare the local checkout for you.",
        details:
      ...
      },
      {
        ...
        description:
          "Completion alerts stay quiet while Zog is in front of you, and provider update notices refresh more reliably when you return.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "Human interactions are now fenced to the owning provider request and turn across Claude and OpenCode. Resolved guards remain resolved, stale cross-turn requests are ignored, retryable interactions stay visible, and OpenCode permission replies wait for a real acknowledgement before Zog clears them.",
      },
      {
        id: "provider-skills-and-models",
        title: "Installed skills and favourite models stay discoverable",
        description:
          "Zog now finds installed Claude plugin skills and keeps similarly named favourite models tied to the correct provider.",
        details:
      ...
      },
      {
        ...
        description:
          "Zog no longer treats interrupted or errored work as a successful completion or repeats an alert as timestamps change.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Zog negotiates one authenticated connection, compresses large traffic, and resumes thread detail from a cursor when possible.",
        details:
    ...
    features: [
      {
        ...
        description:
          "Interrupt and stop actions now take priority over new work, even when a busy Zog server has filled its ordinary command queue.",
        details:
      ...
      },
      {
        ...
        details:
          "Zog retains enough turn identity to settle late Claude results, fences stale lifecycle generations, reconciles durable provider commands and runtime events, and aligns Codex, Claude, Cursor, and ACP session ownership through start, stop, reconnect, and restart boundaries.",
      },
      {
    ...
    features: [
      {
        ...
        details:
          "Zog now normalizes live and settled tool activity into one presentation model, preserves expandable tool details and interactions, and reconciles terminal states without leaving duplicate or permanently running work rows behind.",
      },
      {
      ...
      },
      {
        ...
        details:
          "Zog abandons ambiguous blockers oldest-first, then replays only the skipped turn starts. This restores the conversation without risking a duplicate resend of the command whose delivery could not be proven.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Zog loads expensive provider and diff machinery only when needed and computes working-tree statistics without transferring full patches.",
        details:
      ...
      },
      {
        ...
        details:
          "Database access now proves exclusive ownership, migration backups and resumable artifacts receive broader retention and reclamation coverage, and orphan cleanup stays bounded to verified Zog-owned paths.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "Zog now detects and repairs the database state that could leave some 0.6.0 installations stuck during startup.",
        details:
  ...
  },
  {
    ...
    features: [
      {
        id: "external-zog-mcp",
        title: "Bring Zog to any MCP-capable agent",
        description:
          "Connect Codex, Claude Code, Claude Desktop, or another local MCP app, then let it discover your Zog workspace, launch isolated tasks, wait for results, and bring the answer back.",
        details:
      ...
      {
        id: "built-in-zog-mcp",
        title: "Zog's agents can now operate Zog",
        description:
          "Every supported agent running inside Zog receives built-in tools to understand the app, delegate work, coordinate parallel tasks, inspect failures, and manage automations.",
        details:
          "The new Zog Agent Gateway can list and read projects and tasks, create one task or an exact multi-agent batch across providers and models, wait for every result, continue or interrupt work, rename or archive tasks, inspect runtime diagnostics, and manage automation lifecycles. Thread-bound authority, privilege caps, idempotent creation, isolated worktrees, and restart recovery keep delegated work visible and contained.",
      },
      {
        id: "project-spaces",
      ...
      },
      {
        ...
        description:
          "Follow Claude's native subagents and dynamic workflows as real Zog work, with live status, phases, tools, usage, steering, and background controls.",
        details:
      ...
      },
      {
        ...
        description:
          "Mention an existing Zog task from the composer to give the current agent the right recent context without copying a transcript by hand.",
        details:
      ...
      },
      {
        ...
        details:
          "Zog prefetches provider models before the composer opens, avoids a redundant first-turn Claude permission wait, prepares Codex overlays without blocking, parallelizes independent turn-start I/O, reduces streaming SQL work, and expands React Compiler coverage across the web app.",
      },
      {
        ...
        details:
          "Highlights include Fable 5 and Opus 4.8 in Pi, namespaced Cursor and Grok model support, accurate Claude context windows, official ACP SDK handling, app-owned OpenCode review commands, isolated Codex child events, safer provider updates, preserved blank PATH defaults, and an Antigravity hook that no longer launches Zog unexpectedly.",
      },
      {
    ...
    features: [
      {
        ...
        details:
          "The new provider adapter covers installation and authentication guidance, model and effort discovery, session creation and resume, tool and plan events, permission requests, usage reporting, cancellation, and restart recovery. Zog also includes dedicated Antigravity branding throughout provider setup and selection.",
      },
      {
      ...
      },
      {
        ...
        details:
          "Model-catalog queries retain successful and cached data when one Cursor discovery path fails, while pull-request data is coalesced through shared list logic and picker popups use a unified interaction model. Diff headers now use Zog's own visual chrome for a more consistent workspace.",
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        title: "Review pull requests without leaving Zog",
        description:
      ...
      },
      {
        ...
        description:
          "Zog restores the previous desktop window size, position, and maximized state while keeping reopened windows on a visible display.",
        details:
    ...
    features: [
      {
        ...
        description:
          "Press both Option keys to capture the window you are using and attach it to the current Zog task.",
        details:
    ...
    features: [
      {
        ...
        description:
          "Droid is now available alongside Zog's other agents, with runtime model discovery, session import, token multipliers, and resilient resume and recovery.",
        details:
          "Zog now connects to Factory Droid through ACP, discovers models and their switching capabilities at runtime, imports existing Droid sessions, carries context across forks and restarts, and keeps bootstrap, configuration, and turn teardown state coherent. The release also adds the Factory logo and richer Droid token reporting.",
      },
      {
        id: "large-history-startup",
        title: "Large conversation histories start reliably",
        description:
          "Zog now upgrades large local histories without leaving the project list stuck on its loading screen.",
        details:
    ...
    features: [
      {
        ...
        details:
          "The desktop bundle is now com.lawrence-millard.zog, the CLI is @zog/cli with the zog command, and every first-party runtime identifier uses the Zog namespace. The 0.4.2 bridge preserves renderer state during the origin change.",
      },
      {
  ...
  },
  {
    ...
    features: [
      {
        id: "zog-identity-bridge",
        title: "Zog is preparing a seamless identity upgrade",
        description:
          "Launch this version at least once before installing the next Zog release so your drafts, pins, theme, browser state, and other local interface preferences move with you.",
        details:
          "This bridge writes a validated Zog-only snapshot of renderer state, keeps existing project and thread data intact, and prepares database and checkpoint metadata for the final identity cutover. Earlier command and environment aliases are accepted by this bridge release only and will be removed next.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Zog checks that an update actually installed after restart, detects failed installs, and recovers instead of silently staying on the old version.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Zog is more careful about restoring the right destination after reloads, segment switches, reconnects, and partially completed project creation.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "When Claude reports usage or rate-limit trouble, Zog now presents the condition more calmly instead of turning it into a generic provider failure.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Zog is better at shutting down stubborn terminal process trees without returning early while child processes are still alive.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "When a worktree setup step fails, Zog now shows the failed setup state, keeps the timeline from looking stuck, and resets the local dispatch when you send again.",
        details:
      ...
      },
      {
        ...
        description:
          "Zog avoids unnecessary provider refresh work during startup and gates Claude keepalive behavior more carefully, so opening the app is calmer and less likely to fight credential checks.",
        details:
    ...
    features: [
      {
        ...
        description:
          "When Zog is downloading a desktop update, the sidebar update button now shows a live percent badge so you can tell whether it is moving or nearly ready.",
        details:
      ...
      },
      {
        ...
        description:
          "Zog preserves the first pre-turn snapshot more carefully, so transcript diffs and restore points better match what was on disk when you pressed send.",
        details:
    ...
    features: [
      {
        ...
        description:
          "Zog now finds Cursor agent commands across more install layouts, including bundled sibling shims and legacy shim locations, while rejecting unsafe fallbacks.",
        details:
      ...
      },
      {
        ...
        description:
          "Zog refreshes Claude credential freshness on macOS so long sessions are less likely to hit the familiar stale-token sign-in failure.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "Zog now reuses the central robot glyph for agent chips, improves file-change and tool-call labels, refines chat card contrast, and tightens shared switch sizing, thumb travel, and animation.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "Zog can now launch VS Code Store installs through the right Windows app identity and URI fallback, so editor buttons work even when the normal `code` command is unavailable.",
        details:
      ...
      },
      {
        ...
        description:
          "A new settings toggle lets you disable provider update checks when you want Zog to stay quieter about external CLI versions.",
        details:
      ...
      },
      {
        ...
        title: "The app icon and Zog mark look cleaner",
        description:
          "The desktop, web, marketing, and release assets were refreshed so the Zog icon renders more consistently across macOS, Windows, browser favicons, and update artifacts.",
        details:
          "This release refreshes the inline Zog logo path, replaces generated icon assets from the full source image, corrects macOS bundle icon handling after the rounded-icon Ventura pass, and removes a literal Dock-icon workaround that was not the final direction.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Zog polls local server state less aggressively while idle, reducing background work without changing the active-session refresh path.",
        details:
    ...
    features: [
      {
        ...
        description:
          "The branch toolbar can now show and change the active project, so project, branch, and worktree context are easier to keep aligned while you move around Zog.",
        details:
      ...
      },
      {
        ...
        details:
          "Zog now builds file diff trees, renders a collapsible review panel with shared disclosure motion, and reuses file-row styling so review navigation feels closer to the rest of the workspace.",
      },
      {
    ...
    features: [
      {
        ...
        details:
          "Zog now formats tool command transcripts, normalizes patch/change output, labels more tool kinds consistently, preserves structured work metadata through the timeline, and adds focused coverage for tool-call labels and formatting.",
      },
      {
        id: "transcript-flow",
      ...
      },
      {
        ...
        details:
          "Zog now ships a curated central-icons set, improves provider/model picker presentation, refines composer picker and automation banners, adds better project/thread hover details, and keeps repeated UI surfaces closer to the same visual language.",
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        description:
          "Zog now has first-class Automations for scheduled agent work, with sidebar navigation, list/detail pages, run history, triage actions, and inline editing.",
        details:
      ...
      },
      {
        ...
        details:
          "File attachments now flow through contracts, upload storage, composer paste/drop, provider prompts, Kanban dispatch, recap/bootstrap surfaces, optimistic timeline rendering, caps/rollback, attachment-bearing plan follow-ups, explicit unsupported-file rejection, worktree-backed file preview roots, and blob-based download handling that keeps failed local image downloads inside Zog.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "Zog now waits for one fresh server snapshot before giving up on a remembered chat route, so app restarts are less likely to dump you onto an empty fallback screen.",
        details:
    ...
    features: [
      {
        ...
        description:
          "Zog now tracks richer local profile stats, including your most worked project, skill and agent usage, active hours, provider/model mix, and prompt activity.",
        details:
          "Profile stats now derive more signal from Zog's local projection database: most-worked project, prompt/thread activity, skill and agent usage, provider/model usage, reasoning patterns, active-hour windows, and token heatmap data are all represented in the profile contract and settings panel.",
      },
      {
    ...
    features: [
      {
        ...
        title: "Your Zog profile has more personality",
        description:
          "Profile settings now include richer identity details, activity stats, and a cleaner editing flow so Zog feels more like your own workspace.",
        details:
      ...
      },
      {
        ...
        details:
          "Zog now tracks thread retention state explicitly, covers soft-delete cleanup behavior with server tests, and keeps deletion/recovery semantics more predictable for early WIP data.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "After provider restarts, reconnects, or quiet ACP sessions, Zog does a better job of reconciling active turns and finishing idle work instead of getting stuck.",
        details:
    ...
    features: [
      {
        ...
        title: "PDFs open safely inside Zog",
        description:
      ...
      },
      {
        ...
        details:
          "Zog now routes file preview through `WorkspaceFilePreview`, `PdfFilePreview`, shared preview headers, markdown/source selection references, workspace file openers, dock pane activation metadata, local preview URL helpers, and tighter file reference context-menu behavior.",
      },
      {
        id: "pi-plugin-routing",
        title: "Pi plugin sessions start in the right place",
        description:
          "Pi-backed plugin flows now route through Zog more reliably, discover model support better, and keep startup prompts attached to the correct provider session.",
        details:
      ...
      },
      {
        ...
        details:
          "Zog now preserves Cursor message identity more reliably, removes the older turn diff tree path, refines changed-file file-list rendering, fixes duplicate plan-mode icons and stale plan sidebar state, and hides inline project actions from the chat header where they created noise.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "Zog now discovers native editor apps and icons, caches icon assets server-side, exposes authenticated icon routes, and tightens macOS/Linux/Windows launcher handling, including Ghostty working-directory behavior and Linux desktop-entry matching.",
      },
      {
        id: "portable-skills",
      ...
      },
      {
        ...
        details:
          "Zog now reconciles legacy migration bookkeeping before running migrations, expands migration coverage, validates workspace real-path containment, and carries terminal environment updates through shared server and web contracts.",
      },
    ],
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "Zog now reads provider credentials and usage data through shared server parsers, normalizes snapshots, stores cached values in SQLite, and renders reusable usage rows, progress tracks, line lists, and settings panels in the web app.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "Zog now caches site favicons server-side, serves authenticated favicon image URLs, recognizes bare domains in composer text, and keeps markdown link text aligned with the same medium-weight chip styling used while composing.",
      },
      {
    ...
    features: [
      {
        ...
        details:
          "Release tooling now validates Mac update artifacts, parses boolean environment flags consistently, and tests the resumable update downloader without the older update-feed cache layer. The README and release docs were refreshed around the current Zog desktop flow too.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "Claude SIGTERM from outside Zog is treated as a benign suspend path, terminal process cleanup has stronger tests, and websocket RPC failure handling is less likely to leave the UI believing a request is still in flight.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Zog can now generate and cache thread recaps, show current-state context in the chat environment, and reuse provider-backed recap generation without making the transcript harder to follow.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "When Claude reports a missing conversation id, Zog clears the stale resume cursor, recreates the provider session, and retries with transcript context instead of leaving the turn failed.",
      },
      {
        id: "desktop-update-manual-fallback",
        title: "Desktop updates now have a manual escape hatch",
        description:
          "If an in-app install silently fails, Zog restarts the backend, resumes update polling, deduplicates error toasts, and points you at the exact GitHub release page for a manual download.",
      },
      {
      ...
      },
      {
        ...
        description:
          "OpenCode task child sessions and newer shell-step events now flow into Zog's activity timeline, while generic agent task rows keep their useful prompt and result text instead of disappearing or showing wrapper noise.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "OpenCode startup, model discovery, command discovery, server connection options, and experimental WebSocket mode now flow through the same settings and runtime paths as the rest of Zog.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Fresh repair migrations reconcile older imported migration trackers that skipped Zog's sidechat-source or pinned-thread columns, preventing startup crashes in those upgraded histories.",
      },
      {
  ...
  },
  {
    ...
    features: [
      {
        id: "zog-home-migration",
        title: "Zog is now the default home",
        description:
          "The app now starts from `~/.zog`, carries the Zog environment variables through the desktop and server runtime, and safely imports data from previous installations on first launch.",
      },
      {
    ...
    features: [
      {
        ...
        description: "Zog now includes Claude Opus 4.8 in the Claude model picker.",
      },
    ],
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "The provider picker no longer treats unknown provider status as usable. Providers stay in a checking state until Zog has confirmed that the local runtime is available and authenticated.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Zog can now launch and monitor Kilo Code sessions alongside Codex, Claude, Cursor, OpenCode, and Gemini, with health checks, settings, mentions, handoff, and model compatibility wired through the app.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "Zog now tracks the newer OpenCode SDK session events, keeps titles fresher, and has much deeper coverage around OpenCode startup, output, and recovery flows.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Zog now serves generated files through a dedicated local-image endpoint with MIME checks, workspace-aware path resolution, and Codex generated_images allowlists for both the normal home and desktop overlay home.",
      },
      {
  ...
  },
  {
    ...
    features: [
      {
        id: "cursor-provider",
        title: "Cursor is now a first-class Zog provider",
        description:
          "Run Cursor CLI sessions directly from Zog with ACP-backed startup, model discovery, existing-chat resume, handoff, and provider health checks alongside Codex and OpenCode.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "The Git actions menu can now commit current work and push it from Zog, keeping the common release and handoff flow closer to the chat.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "The Git menu now includes branch creation with Zog-style names, and PR creation can recover from GitHub duplicate-PR responses by reusing the existing open pull request.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "OpenCode todo events now flow into Zog as active task updates, with a compact banner option for keeping current work visible without taking over the chat.",
      },
      {
      ...
      },
      {
        ...
        description:
          "OpenCode sessions now report context usage more consistently, giving Zog better runtime visibility as conversations grow.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "Cursor is now available as a provider, with ACP sessions, model discovery, existing chats, handoff, shortcuts, and git text generation wired into Zog.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Toast notifications picked up feature-flag wiring, giving Zog a safer way to roll notification changes forward or back.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "Zog now handles messy branch switches with clearer recovery actions, recreated stashes, unpublished branch publishing, and stronger checks around conflicts and local work.",
      },
      {
      ...
      },
      {
        ...
        description:
          "The desktop app now has app-level back and forward navigation controls, making it easier to move around Zog without losing your place.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "GPT-5.5 is now in the model picker with the right default reasoning behavior, so you can move new Codex sessions onto the latest model directly from Zog.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Zog now shows a proper splash screen while the desktop backend spins up, so launch feels intentional instead of looking briefly stalled.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "The new theme pack editor lets you tune UI colors directly in Zog, with shared theme tokens keeping the sidebar, composer, transcript, and controls in sync.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "If the updater never answers, Zog now times out and recovers instead of hanging on a permanent Checking status.",
      },
    ],
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Point Zog at your own Codex, Claude, or Gemini binary when your setup lives outside the default install path.",
      },
      {
