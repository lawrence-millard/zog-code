// FILE: vite.config.ts
// Purpose: Builds the Zog web client and controls diagnostic source maps.
...
const sourcemapEnv = process.env.ZOG_WEB_SOURCEMAP?.trim().toLowerCase();
