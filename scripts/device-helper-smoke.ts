...
import { decodeDeviceFrame } from "@zog/shared/deviceFrame";
import {
...
async function main(): Promise<void> {
  ...
  // comes from @zog/shared so this build lands in the same directory the
  ...
  try {
    ...
    const socketDir = mkdtempSync(join(tmpdir(), "zog-device-smoke-"));
