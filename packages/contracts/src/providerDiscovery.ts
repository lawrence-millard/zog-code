...
// Unified cross-provider skills catalog (Zog portable skills). Descriptors use
// `scope` to carry the origin label ("zog", "codex", "claude", "cursor", ...).
...
export const ProviderSkillsCatalogResult = Schema.Struct({
  skills: Schema.Array(ProviderSkillDescriptor),
  zogSkillsDir: Schema.optional(TrimmedNonEmptyString),
});
