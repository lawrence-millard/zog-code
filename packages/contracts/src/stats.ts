...
// the shareable activity card. All metrics are backed by Zog's local DB
...
export const ProfileActivity = Schema.Struct({
  ...
  // totalPromptsSent), i.e. days the user actually used Zog.
...
// Token totals come from Zog's projected context-window updates. `available`
