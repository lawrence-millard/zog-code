...
import {
  ZogCapabilitiesResult,
  ZogCreateThreadsInput,
  ZogCreateThreadsResult,
  ZogGatewayErrorResult,
  ZogWaitForThreadsInput,
  ZogWaitForThreadsResult,
} from "./agentGateway";

const decodeCreate = Schema.decodeUnknownSync(ZogCreateThreadsInput);
const decodeWait = Schema.decodeUnknownSync(ZogWaitForThreadsInput);
...
describe("agent gateway contracts", () => {
  ...
  it("decodes typed capability, creation, wait, and error results", () => {
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(ZogCapabilitiesResult)({
        targetConstruction: {
          codex: {
    ...
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(ZogCreateThreadsResult)({
    ...
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(ZogWaitForThreadsResult)({
    ...
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(ZogGatewayErrorResult)({
