...
const PATH_CAPTURE_START = "__ZOG_PATH_START__";
const PATH_CAPTURE_END = "__ZOG_PATH_END__";
 ...
 */
export const SHELL_ENVIRONMENT_HYDRATED_ENV_NAME = "ZOG_PATH_HYDRATED";
...
function envCaptureStart(name: string): string {
  return `__ZOG_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__ZOG_ENV_${name}_END__`;
}
